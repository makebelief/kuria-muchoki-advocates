...
contactRail.innerHTML = `
  <button class="rail-action rail-toggle" type="button" aria-expanded="false" aria-controls="contact-rail" aria-label="Expand quick contact actions" title="Expand quick contact actions">
    <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 12h13M13 6l6 6-6 6" /></svg>
  </button>
  <a class="rail-action" href="https://wa.me/254713486035?text=Hello%20Kuria%20Muchoki%20%26%20Co.%20Advocates%2C%20I%20would%20like%20to%20make%20an%20enquiry." target="_blank" rel="noopener noreferrer" aria-label="Start a WhatsApp conversation" title="WhatsApp">
  ...
  <a class="rail-action" href="tel:+254713486035" aria-label="Call Kuria Muchoki and Company Advocates" title="Call 0713 486 035">
